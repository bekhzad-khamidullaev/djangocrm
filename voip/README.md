...
**Система готова к использованию! 🎉**## 📡 Интеграция с Asterisk Real-time

Django CRM поддерживает встроенную интеграцию с Asterisk PBX через Real-time базу данных.

### Возможности

- **Автоматическое provisioning** SIP endpoints для пользователей
- **Управление через AMI** - инициация звонков, запись разговоров
- **Real-time конфигурация** - динамическое управление без перезагрузки
...
См. подробное руководство: **[ASTERISK_REALTIME_SETUP.md](../ASTERISK_REALTIME_SETUP.md)**

```bash
# 1. Установите Asterisk 18+
...
- [Полное руководство по настройке](../ASTERISK_REALTIME_SETUP.md)
- [Backend API](backends/asteriskbackend.py)
- [Утилиты](utils/asterisk_realtime.py)
- [Management команды](management/commands/setup_asterisk_realtime.py)
